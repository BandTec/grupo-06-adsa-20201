...
function plotarCPU1(leituraUsoPorc) {
    var ctx = document.getElementById("chartCPU1").getContext("2d");
...
function atualizarMemoria() {
    fetch("http://localhost:3000/leituras/dadoCPU1", { cache: "no-store" })
