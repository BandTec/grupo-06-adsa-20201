...
function plotarDisco1(leituraUsoPorc) {
    var ctx = document.getElementById("chartDisco1").getContext("2d");
...
function atualizarMemoria() {
    fetch("http://localhost:3000/leituras/dadoDisco1", { cache: "no-store" })
